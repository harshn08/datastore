...
public class ResourceFactory {
   ...
   public static void initialize(ServerConf cfg) {
	...
	public static ResourceFactory getInstance() {
		...
		//System.out.println("rf=factory.get()"+rf);
		if (rf == null)
...
public static List<String> determineIP(Request request,String uuid) throws Exception{
		List<String> iplist=new ArrayList<String>();
	System.out.println("In resource factory computing IP s");
	for (NodeDesc nd : cfg.getAdjacent().getAdjacentNodes().values()) {
		System.out.println("Adding IPs to list");
		
		iplist.add(nd.getHost());
